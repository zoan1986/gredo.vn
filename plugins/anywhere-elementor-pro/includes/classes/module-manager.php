...
class ModuleManager
{
	...
	{
		\Elementor\Plugin::$instance->dynamic_tags->register_group('ae-post-dynamic', [
		...
		if (AE_ACF) {
			...
			\Elementor\Plugin::$instance->dynamic_tags->register_group('ae-dynamic', [
		...
		if (class_exists('woocommerce')) {
			\Elementor\Plugin::$instance->dynamic_tags->register_group('ae-woo-dynamic', [
