...
class Aepro
{
    ...
    function editor_after_enqueue_styles()
    {
    ...
    function _editor_enqueue_scripts()
    {
        ...
        wp_register_script('ae-elementor-editor-js-build', AE_PRO_URL . 'build/index.js', array('jquery', 'ae-gmap'), AE_PRO_VERSION);
    ...
    public function _enqueue_scripts()
    {
        ...
        wp_enqueue_script('aep-build', AE_PRO_URL . 'build/index.js', array('jquery'), AE_PRO_VERSION, true);
        ...
        wp_localize_script('aep-build', 'aepro', array(
            'ajaxurl' => admin_url('admin-ajax.php'),
            'current_url' => base64_encode($helper->get_current_url_non_paged()),
            'breakpoints' => Elementor\Core\Responsive\Responsive::get_breakpoints(),
            'plugin_url' => plugins_url('anywhere-elementor-pro')
        ...
        wp_register_script('ae-masonry', AE_PRO_URL . 'includes/assets/lib/masonry/js/masonry.pkgd' . AE_PRO_SCRIPT_SUFFIX . '.js', array('jquery', 'jquery-masonry'), '2.0.1', true);
