...
class Album extends Powerpack_Widget {
    ...
    protected function get_album_content() {
        ...
        if ( $settings['album_icon'] || $settings['album_title'] || $settings['album_subtitle'] || $settings['album_cover_button'] == 'yes' ) {
			$content_html .= '<div class="pp-album-content-wrap">';
			$content_html .= '<div class="pp-album-content">';
				$content_html .= '<div class="pp-album-content-inner">';
					if ( $settings['album_icon'] ) {
						$content_html .= '<div class="pp-album-icon ' . $settings['album_icon'] . '"></div>';
					}
					if ( $settings['album_title'] ) {
						$content_html .= $this->get_album_title();
					}
				...
				if ( $settings['album_cover_button'] == 'yes' ) {
					$content_html .= $this->get_album_cover_button();
				}
            $content_html .= '</div>';
            $content_html .= '</div>';
        }
    ...
    protected function get_album_cover_button() {
		...
		<div class="pp-album-cover-button-wrap">
			<div <?php echo $this->get_render_attribute_string( 'cover-button' ) ?>>
				<?php if ( ! empty( $settings['album_cover_button_icon'] ) && $settings['album_cover_button_icon_position'] == 'before' ) { ?>
					<span class="pp-button-icon <?php echo esc_attr( $settings['album_cover_button_icon'] ); ?>" aria-hidden="true"></span>
				<?php } ?>
				...
				<?php } ?>
				<?php if ( ! empty( $settings['album_cover_button_icon'] ) && $settings['album_cover_button_icon_position'] == 'after' ) { ?>
					<span class="pp-button-icon <?php echo esc_attr( $settings['album_cover_button_icon'] ); ?>" aria-hidden="true"></span>
				<?php } ?>
			</div>
		</div>
    ...
    protected function get_album_trigger_button() {
		...
		if ( ! empty( $settings['album_trigger_button_icon'] ) ) {
		...
		<div class="pp-album-trigger-button-wrap">
			<a <?php echo $this->get_render_attribute_string( 'trigger-button' ) ?>>
				<span <?php echo $this->get_render_attribute_string( 'trigger-button-content' ) ?>>
					...
					<?php } ?>
					<?php if ( ! empty( $settings['album_trigger_button_icon'] ) ) { ?>
						<span class="pp-button-icon <?php echo esc_attr( $settings['album_trigger_button_icon'] ); ?>" aria-hidden="true"></span>
					<?php } ?>
				</span>
			</a>
		</div>
