...
add_action( 'wp_ajax_pafe_export_database', 'pafe_export_database' );
add_action( 'wp_ajax_nopriv_pafe_export_database', 'pafe_export_database' );

function pafe_export_database_prepare_http_header() {
...
function pafe_export_database() {
	pafe_export_database_prepare_http_header();
