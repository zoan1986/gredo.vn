...
define( 'PAFE_PRO_VERSION', '6.3.73' );
define( 'PAFE_PRO_PREVIOUS_STABLE_VERSION', '6.3.72' );

$license = array();
$license['license_key'] = '1415b451be1a13c283ba771ea52d38bb';
$license['email'] = 'hello@example.com';
$license['license_name'] = 'gplvault';
...
update_option( 'piotnet-addons-for-elementor-pro-username', 'gplvault' );
