			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'default' => '#6b7e92',
						'selectors' => [
							'{{WRAPPER}} .pafe-advanced-search__results-item-content' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
							'{{WRAPPER}} .pafe-advanced-search__results-item-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			$this->end_controls_tab();
